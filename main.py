...
try:
    ...
    def chpath():
        ...
        if not Path(browsepath).is_dir:
            print("==========================")
            print("The path specified is a file. Please point at a correct directory. Press shift+enter to return to file browsing.")
        else:
            try:
                sf = Path(browsepath)
                update()
    ...
    os.system("clear")
    import logo
    print("Welcome to SwiftStore! Press shift+enter to begin.")
    rehook()
    kb.wait()
